 ...
 * 
 */
@WebServiceClient(name = "UserManagerService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/Manager?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Manager?wsdl");
